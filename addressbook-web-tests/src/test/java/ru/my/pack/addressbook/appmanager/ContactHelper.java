...
public class ContactHelper extends HelperBase {
    ...
    public void createContactIfNotExist(Contacts contacts, ContactData newContactData) {
        if (contacts.size() == 0) {
            contactPage();
            gotoAdd();
            ContactData contact = new ContactData()
                    .withFirstName(newContactData.getFirstName())
                    .withLastName(newContactData.getLastName())
                    .withAddress(newContactData.getAddress())
                    .withEmail(newContactData.getEmail());
            create(contact,
                    true);
        }
    }
...
//      String allPhones = element.findElement(By.xpath("td[6]")).getText();
    ...
    public void selectAllGroup() {
        new Select(wd.findElement(By.name("to_group"))).selectByVisibleText("[all]");
    }
